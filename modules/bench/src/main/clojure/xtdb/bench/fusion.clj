...
(def manufacturers ["Tesla" "Enphase" "SolarEdge" "Fronius" "SMA"])
(def models ["Powerwall" "IQ8" "SE7600" "Primo" "Sunny Boy"])
...
(defmethod b/->benchmark :fusion [_ {:keys [devices readings batch-size update-batch-size
  ...
  (let [system-ids (generate-ids devices)
    ...
    {:title "Fusion benchmark (Synergy-style workload)"
